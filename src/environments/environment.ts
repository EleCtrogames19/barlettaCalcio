...
import { Unsubscribe, addDoc, collection, doc, getDoc, getFirestore, limit, onSnapshot, orderBy, query, setDoc, where } from 'firebase/firestore';
...
let unsubscribeCustomerOrders: Unsubscribe;
